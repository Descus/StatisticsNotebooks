...
- Apply the following R statements
...
The data set production contains the combination of product,
country, and year.
Widen the data so we have one column for each combination of
product and country.
